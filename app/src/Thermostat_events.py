...
def tftHvacModeChange(event_struct):
    return
...
def tftStopTouchTimer(event_struct):
    return
...
def LoadInfoStrings(event_struct):
    return
...
def tftUpdateTempCorrectionValue(event_struct):
    return


def tftUpdateTempSwingValue(event_struct):
    return
