...
lv_textarea_set_text(ui_MqttHostname,"MQTT Host");
lv_textarea_set_placeholder_text(ui_MqttHostname,"Placeholder...");
...
lv_textarea_set_text(ui_MqttUsername,"Username");
lv_textarea_set_placeholder_text(ui_MqttUsername,"Placeholder...");
...
lv_textarea_set_text(ui_MqttPassword,"Password");
...
ui_MqttPwdLabel = lv_label_create(ui_MqttConfig);
lv_obj_set_width( ui_MqttPwdLabel, LV_SIZE_CONTENT);  /// 1
lv_obj_set_height( ui_MqttPwdLabel, LV_SIZE_CONTENT);   /// 1
lv_obj_set_x( ui_MqttPwdLabel, 230 );
lv_obj_set_y( ui_MqttPwdLabel, -99 );
lv_obj_set_align( ui_MqttPwdLabel, LV_ALIGN_LEFT_MID );
lv_label_set_text(ui_MqttPwdLabel,"Password:");
...
lv_obj_set_y( ui_MqttSaveBtn, -20 );
...
lv_obj_set_y( ui_MqttSaveLabel, -20 );
...
lv_obj_set_y( ui_MqttCancelBtn, -60 );
...
lv_obj_set_y( ui_MqttCancelLabel, -60 );
