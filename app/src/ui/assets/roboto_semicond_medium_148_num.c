 ...
 * Size: 148 px
 * Bpp: 2
 * Opts: --bpp 2 --size 148 --no-compress --font Roboto_SemiCondensed-Medium.ttf --symbols 1234567890 --format lvgl -o roboto_semicond_medium_148_num.c
 ******************************************************************************/
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t roboto_semicond_medium_148_num = {
#else
lv_font_t roboto_semicond_medium_148_num = {
#endif
